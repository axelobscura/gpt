  ...
  return (
    <div className="grid h-screen max-h-screen">
      <div className="flex flex-col items-center justify-center px-4">
        ...
        <div className="w-full block p-2 grid fixed bottom-0 left-0 right-0 bg-white">
          <form onSubmit={handleSubmit} className="w-full block p-4 pr-10 grid grid-cols-[90%_1fr_1fr]">
            <input type="text" id="tema" name="tema" placeholder="Envía un mensaje a Asistente IMCYC" value={tema} onChange={(e) => setTema(e.target.value)} className="w-full px-1 py-1 rounded-md mb-4 text-gray-900 border-gray-900 h-90" style={{
